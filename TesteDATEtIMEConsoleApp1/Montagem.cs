...
namespace TesteDATEtIMEConsoleApp1
{
    ...
    {
        public string EscreveAnos(Periodos periodo)
        {
        ...
        public string EscreveMeses(Periodos periodo)
        {
        ...
        public string EscreveSemanas(Periodos periodo)
        {
        ...
        public string EscreveDias(Periodos periodo)
        {
